...
if (!class_exists('BudgetBuddy')) {
    class BudgetBuddy {
        public function __construct() {
            ...
            // Activation hooks moved to main file bootstrap
        ...
        public function enqueue_assets() {
            $plugin_url = defined('BUDGET_BUDDY_URL')
                ? BUDGET_BUDDY_URL
                : plugin_dir_url(dirname(__DIR__) . '/budget-buddy.php');
        ...
        public function run_plugin() {
            if (is_admin()) {
                PucFactory::buildUpdateChecker(
                    ...
                    defined('BUDGET_BUDDY_FILE') ? BUDGET_BUDDY_FILE : dirname(__FILE__) . '/../budget-buddy.php',
                    'budget-buddy'
                );
            }
        }
        ...
        public function tracker_shortcode($atts) {
            ...
            ob_start();
            $template_file = (
                defined('BUDGET_BUDDY_DIR')
                    ? BUDGET_BUDDY_DIR
                    : plugin_dir_path(dirname(__DIR__) . '/budget-buddy.php')
            ) . 'templates/budget-main.php';
